// src/server.ts - Updated to include account routes
...
import accountRoutes from "./routes/accountRoutes"; // Add this import
...
app.use("/api/account", accountRoutes); // Add this route
